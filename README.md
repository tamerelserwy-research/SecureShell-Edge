...
| `SecLLM_PowerShell_Dataset.json` | The evaluation dataset of 6,308 PowerShell commands with labels (see [Dataset]([dataset](https://doi.org/10.5281/zenodo.18636114))). |
